...
export default function App() {
  ...
  function handleAddingFriend(friend) {
  ...
  return( 
    <div className="app">
      <div className="sidebar">
        ...
        {showAddFriend && <FormAddFriend onAddingFriend={handleAddingFriend} />}
...
function Friend({friend , onSelection , selectedFriend}) {
  ...
  return (
    <li className={isSelected ? "selected" : ""}>
      ...
      {friend.balance < 0 && <p className="red">You gives {friend.name} {Math.abs(friend.balance)}$</p>}
      {friend.balance > 0 && <p className="green">{friend.name} gives you {Math.abs(friend.balance)}$</p>}
